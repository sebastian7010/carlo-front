    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-playfair text-3xl md:text-4xl font-bold text-foreground mb-4">{t("featured.title")}</h2>
            ...
            return (
              ...
              >
                <CardHeader className="text-center pb-4">
                  ...
                  {section.featured && (
                    <div className="inline-block px-2 py-1 bg-purple-600 text-white text-xs rounded-full font-medium">
                      {t("featured.new")}
                    </div>
                  )}
                </CardHeader>
