      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-4">
            ...
            {t("invitations.exploreDiscover")}
          </div>
          <h2 className="font-playfair text-3xl md:text-4xl font-bold text-foreground mb-4">
            {t("invitations.title")}
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">{t("invitations.subtitle")}</p>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              <h3 className="font-playfair text-xl font-semibold text-foreground mb-2">
                {t("invitations.notSure.title")}
              </h3>
              <p className="text-muted-foreground">{t("invitations.notSure.description")}</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/descubre-tu-santo">
                <Button size="lg" className="w-full sm:w-auto">
                  ...
                  {t("invitations.discoverSaint")}
                </Button>
              </Link>
              <Link href="/mapa">
                <Button variant="outline" size="lg" className="w-full sm:w-auto bg-transparent">
                  <MapPin className="h-4 w-4 mr-2" />
                  {t("invitations.exploreMap")}
                </Button>
              </Link>
            </div>
          </div>
